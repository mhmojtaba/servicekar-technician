                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 text-sm text-neutral-700 bg-neutral-50 border border-neutral-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 focus:bg-white transition-all duration-200"
                        placeholder="مثال: TGH-001"
                        required
                        disabled={isSubmitting}
                      />
                    </div>
          ...
          <div className="flex-shrink-0 p-4 sm:p-6 border-t border-neutral-100 bg-neutral-50/50">
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              >
                ...
                <span className="text-sm sm:text-base">افزودن برچسب جدید</span>
              </button>
