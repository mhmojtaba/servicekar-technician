...
const PaymentStatusModal = ({ isOpen, onClose }) => {
  const {
    selectedRequest,
    array_type_payment,
  ...
  useEffect(() => {
    if (selectedRequest && array_type_payment) {
      const currentPayment = array_type_payment.find(
        (payment) => payment.value == selectedRequest.type_payment
      );
        ...
        <div className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-purple-700 p-8 text-white">
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-1">تغییر وضعیت پرداخت</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              <Select
                ...
                isSearchable={true}
                isClearable={true}
                placeholder="وضعیت پرداخت را انتخاب کنید..."
                styles={{
                  ...customSelectStyles,
              ...
              >
                <div className="flex items-center gap-2 text-green-700">
                  ...
                  <span className="font-medium">
                    وضعیت انتخاب شده: {selectedPaymentOption.label}
                  </span>
                </div>
              </motion.div>
            )}
        ...
        <div className="border-t border-gray-100 bg-gray-50/50 p-6">
          <div className="flex justify-end gap-4">
            ...
            <button
              ...
              disabled={!selectedPaymentOption || isGettingRequestsMain}
