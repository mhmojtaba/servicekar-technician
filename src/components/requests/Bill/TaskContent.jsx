              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex-1 min-w-0">
                    <p className="font-medium text-neutral-800 text-xs md:text-base">{task.title}</p>
                  ...
                  <div className="flex items-center gap-2 mr-4 flex-shrink-0">
                    ...
                    <input
                      ...
                      className="w-8 px-1 py-1 border border-neutral-300 rounded text-center text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                      style={{ direction: "ltr" }}
                      placeholder="0"
                    />
                    <button
