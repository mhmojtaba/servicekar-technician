        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3 space-x-reverse w-full">
            <div className="flex items-center justify-between w-full">
              <div className="relative h-14 w-14 rounded-full overflow-hidden border-2 border-primary-100 shadow-sm">
                <Image
                  src={logo}
                  alt="Logo"
                  loading="lazy"
            ...
            {user?.img ? (
              <div className="relative h-14 w-16 rounded-full overflow-hidden border-2 border-primary-100 shadow-sm">
                <Image
                  src={user?.img}
                  alt="User"
                  fill
